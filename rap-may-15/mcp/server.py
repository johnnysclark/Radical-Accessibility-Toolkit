# -*- coding: utf-8 -*-
"""
RADICAL ACCESSIBILITY CONTROLLER — MCP Server  v4.0
====================================
Model Context Protocol wrapper around the Controller CLI, plus:
...
# ── Import console from controller/ directory ───
...
def run_command(command: str) -> str:
    """Execute any Controller CLI command as a raw string.
...
@mcp.tool()
def get_help() -> str:
    """Get the full command reference for the Controller CLI.
...
def extend_controller(function_name: str, code: str) -> str:
    ...
    This extends the Controller with new commands at runtime. The
...
def macro_builder() -> str:
    ...
    return (
        ...
        f"Controller. Here is the current command reference:\n\n"
        f"{cli.HELP_TEXT}\n\n"
        f"Existing macros:\n{macro_text}\n\n"
...
def generate_script(name: str, description: str, code: str,
    ...
    header_lines = [
        ...
        f"# Script: {safe}",
        f"# {description}",
        "# Generated by Radical Accessibility Controller — edit freely!",
        "#",
        "# HOW TO RUN:",
...
if __name__ == "__main__":
    _real_print(f"Radical Accessibility Controller MCP Server v4.0 starting...", file=sys.stderr)
