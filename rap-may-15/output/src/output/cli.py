...
from output.core.processor import ImageProcessor, ImageProcessorError
from output.core.pdf_generator import PIAFPDFGenerator, PDFGeneratorError
from output.config.standards_loader import StandardsLoader, StandardsLoaderError
from output.config.presets import PresetManager, PresetError
from output.utils.logger import AccessibleLogger
from output.utils.validators import (
    validate_image_file,
    validate_threshold,
    validate_paper_size,
...
from output.core.text_detector import TextDetector, TextDetectionConfig
from output.core.braille_converter import BrailleConverter, BrailleConfig
from output.core.label_scaler import analyze_label_fit
...
def convert(input_path, output, threshold, paper_size, verbose, interactive, config, preset, enhance, enhance_strength, save_intermediate, enable_tiling, tile_overlap, no_registration_marks, auto_reduce_density, target_density, max_reduction_iterations, detect_text, braille_grade, braille_placement, zoom_region, scale_percent, auto_scale, max_scale_factor, abbreviation_key, force_abbreviation_key, sticker_workflow):
    ...
    try:
        ...
        if detect_text:
            try:
                from PIL import Image as PILImage
                from output.core.easyocr_detector import EasyOCRDetector
