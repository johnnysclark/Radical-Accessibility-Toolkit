...
def _ensure_imports():
    ...
    from output.core.processor import ImageProcessor as _IP, ImageProcessorError as _IPE
    from output.core.pdf_generator import PIAFPDFGenerator as _PPG, PDFGeneratorError as _PDFE
    from output.config.standards_loader import StandardsLoader as _SL, StandardsLoaderError as _SLE
    from output.config.presets import PresetManager as _PM, PresetError as _PE
    from output.core.braille_converter import BrailleConverter as _BC, BrailleConfig as _BCfg, KeyEntry as _KE
    from output.core.text_detector import TextDetector as _TD, TextDetectionConfig as _TDC, DetectedText as _DT
    from output.core.easyocr_detector import EasyOCRDetector as _EOD
...
async def _process_color_to_tactile(
    ...
    try:
        ...
        from output.utils.validators import resolve_wsl_path, verify_file_exists
