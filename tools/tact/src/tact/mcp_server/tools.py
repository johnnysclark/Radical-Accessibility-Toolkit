...
def _ensure_imports():
    ...
    from tact.core.processor import ImageProcessor as _IP, ImageProcessorError as _IPE
    from tact.core.pdf_generator import PIAFPDFGenerator as _PPG, PDFGeneratorError as _PDFE
    from tact.config.standards_loader import StandardsLoader as _SL, StandardsLoaderError as _SLE
    from tact.config.presets import PresetManager as _PM, PresetError as _PE
    from tact.core.braille_converter import BrailleConverter as _BC, BrailleConfig as _BCfg, KeyEntry as _KE
    from tact.core.text_detector import TextDetector as _TD, TextDetectionConfig as _TDC, DetectedText as _DT
    from tact.core.easyocr_detector import EasyOCRDetector as _EOD
    from tact.core.grid_overlay import create_grid_overlay as _CGO, grid_cell_to_percent as _GCP
    from tact.utils.cache import cache_tesseract_results as _CTR, load_cached_tesseract as _LCT
    from tact.core.label_scaler import analyze_label_fit as _ALF
    from tact.core.rainbowtact import RainbowTactConverter as _RTC, RainbowTactConfig as _RTCfg
...
async def _process_rainbowtact(
    ...
    try:
        ...
        from tact.core.rainbowtact import RainbowTactConverter, RainbowTactConfig
        ...
        from tact.utils.validators import resolve_wsl_path, verify_file_exists
...
async def state_to_piaf(
    ...
    try:
        from tact.core.state_renderer import render as sr_render, density as sr_density
