...
from tact import __version__
from tact.core.processor import ImageProcessor, ImageProcessorError
from tact.core.pdf_generator import PIAFPDFGenerator, PDFGeneratorError
from tact.config.standards_loader import StandardsLoader, StandardsLoaderError
from tact.config.presets import PresetManager, PresetError
from tact.utils.logger import AccessibleLogger
from tact.utils.validators import (
    validate_image_file,
    validate_threshold,
    validate_paper_size,
...
from tact.core.text_detector import TextDetector, TextDetectionConfig
from tact.core.braille_converter import BrailleConverter, BrailleConfig
from tact.core.label_scaler import analyze_label_fit
...
def convert(input_path, output, threshold, paper_size, verbose, interactive, config, preset, enhance, enhance_strength, save_intermediate, enable_tiling, tile_overlap, no_registration_marks, auto_reduce_density, target_density, max_reduction_iterations, detect_text, braille_grade, braille_placement, zoom_region, scale_percent, auto_scale, max_scale_factor, abbreviation_key, force_abbreviation_key, sticker_workflow):
    ...
    try:
        ...
        if detect_text:
            try:
                from PIL import Image as PILImage
                from tact.core.easyocr_detector import EasyOCRDetector
