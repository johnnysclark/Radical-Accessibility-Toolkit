...
from tact.core.braille_converter import BrailleConverter, BrailleConfig, KeyEntry
from tact.core.text_detector import TextDetector, TextDetectionConfig, DetectedText
