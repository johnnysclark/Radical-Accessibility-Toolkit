...
from tact.utils.validators import validate_output_path, resolve_wsl_path, verify_file_exists
from tact.core.braille_converter import BrailleConverter, BrailleConfig, BrailleLabel, KeyEntry, BRAILLE_DPI, BRAILLE_FONT_SIZE_POINTS
...
class PIAFPDFGenerator:
    ...
    def generate_with_tiling(self, image: Image.Image, output_path: str,
        ...
        Raises:
            PDFGeneratorError: If PDF generation fails
        """
        from tact.core.tiler import ImageTiler, TilerConfig
