...
if _mcp_available:
    ...
    gen_msg = _mcp_mod.script_generate(
    ...
    # show_script
    show_msg = _mcp_mod.script_show("test-hello")
    ...
    bad_msg = _mcp_mod.script_generate(
        "test-bad", "Bad script",
        'x = f"hello {name}"\n')
    ...
    bad_msg2 = _mcp_mod.script_generate(
    ...
    miss_msg = _mcp_mod.script_show("nonexistent-script-xyz")
