...
### E.8 Poirier-Quinot, D. (2025). "Cue-preserving auralisations for blind exploration of virtual indoor environments."
- **Venue:** Building Acoustics (SAGE), 2025
- **DOI:** 10.1177/10554181251339605
- **URL:** https://journals.sagepub.com/doi/10.1177/10554181251339605
- **Summary:** Investigates the prerequisites to creating auralisations that preserve auditory cues used by blind individuals during indoor navigation. Focuses on how blind people use echoes, reverberation, and reflected sound to infer room geometry, wall proximity, and opening locations.
- **Relevance:** Directly relevant to the project's planned sonification pipeline. Poirier-Quinot's work on preserving the specific auditory cues blind people use (not just adding sound, but preserving the *right* sounds) provides design requirements for a future sonification of the CMA. A blind user exploring a floor plan through spatial audio needs the same cue-preservation principles.

### E.9 Navarro Villacampa, A., et al. (2025). "Sensing the Invisible: Architectural Approaches to Sonifying Microbial Life in Icelandic Turf Houses through VR."
...
### J.8 ACADIA 2026 Conference Theme: "Humanism Recoded: Reframing Computation and Making through Embodiment and Culture."
- **Venue:** Lawrence Technological University, Southfield MI, October 22--24, 2026
- **URL:** https://2026.acadia.org/
- **Summary:** Conference theme centers embodiment and culture as frames for computational design. Calls for research-based projects, theoretical papers, design workflows, and innovative techniques that advance the field.
- **Relevance:** The 2026 theme is an exceptionally strong fit for the project. "Embodiment" is the core theoretical frame (Merleau-Ponty, Varela, Sennett) for a blind student's haptic, auditory, and textual engagement with architecture. "Culture" connects to the visual culture critique (Outline B) and the disciplinary politics (Outline E). "Reframing computation" describes exactly what the CLI does -- reframing computational design around text and touch rather than vision. The project should position itself as a direct response to this theme.
...
## Section L: Design Cognition & Co-Design Methodology

These works fill gaps in the review's theoretical coverage of design thinking, participatory design, and tangible interfaces -- foundations needed by Outlines A (feedback loops) and D (co-design methodology).

### L.1 Dorst, K. (2011). "The core of 'design thinking' and its application."
- **Venue:** Design Studies, Vol. 32, No. 6, pp. 521-532
- **DOI:** 10.1016/j.destud.2011.07.006
- **URL:** https://www.sciencedirect.com/science/article/pii/S0142694X11000603
- **Summary:** Identifies "framing" as the core of design thinking and proposes abductive reasoning (specifically "abduction type 2") as the fundamental reasoning pattern behind design. Designers must simultaneously discover both "what" to create and "how" to create it -- a double unknown that distinguishes design from analytical problem-solving.
- **Relevance:** Dorst's framing concept applies directly to the CLI's command vocabulary. Each command (`set bay A rotation 30`) is a "frame" -- a way of seeing and manipulating the design situation. The CLI forces explicit framing: every design move must be articulated in language before it is executed, making the framing process auditable and repeatable. Sighted designers frame implicitly through visual manipulation; the CLI makes framing explicit.

### L.2 Cross, N. (2006). *Designerly Ways of Knowing.*
- **Publisher:** Springer
- **ISBN:** 978-1846283000
- **Summary:** Argues that design has its own distinct forms of knowledge and ways of knowing, separate from scientific or humanistic knowledge. Designers use "constructive" thinking -- they move through understanding the problem by attempting solutions. Design knowledge is embodied in process and artifact, not just in propositions.
- **Relevance:** Cross's argument that design knowledge is embodied in process supports the claim that Daniel's CLI-mediated design process generates genuine architectural knowledge -- different in form from visual design knowledge but equally valid as a "designerly way of knowing." The CLI command history is a record of design cognition.

### L.3 Sanders, E.B.N. & Stappers, P.J. (2008). "Co-creation and the new landscapes of design."
- **Venue:** CoDesign, Vol. 4, No. 1, pp. 5-18
- **DOI:** 10.1080/15710880701875068
- **URL:** https://www.tandfonline.com/doi/full/10.1080/15710880701875068
- **Summary:** The standard reference for co-design methodology. Distinguishes between "designing for" (user as subject), "designing with" (user as partner), and "designing by" (user as designer). Traces the shift from user-centered design (researcher designs, user evaluates) to co-design (user shapes the design). Argues that co-design changes the roles of designer, researcher, and user.
- **Relevance:** Essential for Outline D. Sanders & Stappers provide the methodological framework for describing Daniel's role. The project operates in the "designing with" and sometimes "designing by" modes: Daniel shapes tool requirements, identifies spatial relationships sighted developers miss, and uses the tools in studio. He is not a "user" in a study -- he is a co-designer.

### L.4 Ishii, H. & Ullmer, B. (1997). "Tangible Bits: Towards Seamless Interfaces between People, Bits and Atoms."
- **Venue:** CHI '97, pp. 234-241. **Most-cited paper in ACM SIGCHI history.**
- **DOI:** 10.1145/258549.258715
- **URL:** https://dl.acm.org/doi/10.1145/258549.258715
- **Summary:** Proposed Tangible User Interfaces (TUIs) -- coupling digital information with everyday physical objects and architectural surfaces. Introduced three key concepts: interactive surfaces, graspable physical objects coupled to digital data, and ambient media for background awareness. The metaDESK prototype demonstrated physical objects controlling digital representations.
- **Relevance:** The project's pegboard system is a TUI: physical pegs and wires coupled to the digital model through camera digitization. Ishii & Ullmer's framework legitimizes the pegboard not as a workaround but as a principled interface paradigm. The Desk (Outline C) is a tangible interface workstation.

### L.5 Hurst, A. & Tobias, J. (2011). "Empowering individuals with do-it-yourself assistive technology."
- **Venue:** ASSETS '11. **Won 2023 SIGACCESS ASSETS Paper Impact Award.**
- **DOI:** 10.1145/2049536.2049541
- **URL:** https://dl.acm.org/doi/10.1145/2049536.2049541
- **Summary:** Found that 35% or more of purchased assistive technology devices are abandoned. Argues for empowering disabled people to create, modify, or build their own assistive technology rather than purchasing commercial products. Increased control over design, passion, and cost motivated individuals to make their own AT.
- **Relevance:** The project's open-source, Python-stdlib-only architecture enables exactly the DIY modification Hurst & Tobias advocate. The CLI is not a commercial product Daniel must accept as-is -- it is a tool he co-designs and that any programmer can extend. The AT abandonment problem does not apply when the user shapes the tool's design.

---

## Section M: AI-Assisted Development & Interoperability Protocols

These works document AI pair programming as a development methodology and the Model Context Protocol as infrastructure -- both central to how the project was built and how it connects to AI capabilities.

### M.1 Anthropic. (2024). "Model Context Protocol Specification."
- **URL:** https://modelcontextprotocol.io
- **GitHub:** https://github.com/modelcontextprotocol/specification
- **Summary:** Open protocol standardizing how LLMs connect to external tools, data sources, and services via JSON-RPC. Defines a client-server architecture with three server primitives (Prompts, Resources, Tools) and two client primitives (Roots, Sampling). Adopted by OpenAI, Google, Microsoft, and AWS within one year of launch. Now governed by the Linux Foundation.
- **Relevance:** MCP is the project's integration layer: the TACT MCP server exposes tactile conversion functions, and the Layout Jig MCP server exposes modeling commands. MCP enables AI to call project tools without custom integration. The protocol's design -- local-first, tool-agnostic, transport-independent -- aligns with the project's accessibility-first architecture. No academic paper has yet analyzed MCP as accessibility infrastructure; the project's paper may be the first.

### M.2 Anthropic. (2024). "Introducing the Model Context Protocol." Blog post, November 25.
- **URL:** https://www.anthropic.com/news/model-context-protocol
- **Summary:** Announcement describing MCP's motivation (solving the M x N integration problem between LLMs and tools), architecture (host/client/server separation), and early adoption. Positions MCP as "USB-C for AI tool integration."
- **Relevance:** The USB-C analogy is apt for the project: just as USB-C standardizes the physical connection between devices, MCP standardizes the protocol between a blind user's AI assistant and the project's tools. The project demonstrates that standardized AI-tool protocols are also accessibility protocols.

### M.3 Anthropic. (2025). "Claude Code." Product launch, February 2025; general availability May 2025.
- **URL:** https://www.anthropic.com/product/claude-code
- **GitHub:** https://github.com/anthropics/claude-code
- **Summary:** Agentic command-line coding tool that reads codebases, edits files, runs commands, and integrates with development tools. Operates as a command-line agent: the developer sets the objective and retains control over what gets committed. Implements a navigator/driver pair programming model where AI drives and the human navigates.
- **Relevance:** Claude Code is the development tool used to build the entire project. This is methodologically significant: the CLI, the watcher, the MCP servers, the TACT pipeline, and the TASC tools were all developed through conversational AI pair programming. The project is both a product of AI-assisted development and a tool for AI-assisted architectural design. The CLI's screen-reader-native output protocol, its crash-only viewer architecture, and its zero-dependency constraint were all shaped through iterative Claude Code sessions.

### M.4 Peng, S., Kalliamvakou, E., Cihon, P., & Demirer, M. (2023). "The Impact of AI on Developer Productivity: Evidence from GitHub Copilot."
- **Venue:** arXiv:2302.06590
- **URL:** https://arxiv.org/abs/2302.06590
- **Summary:** Randomized controlled trial where developers using GitHub Copilot completed tasks 55.8% faster than the control group. Found heterogeneous effects: less experienced developers benefited more. Suggests AI pair programming can lower barriers to software development.
- **Relevance:** Empirical evidence that AI pair programming accelerates development. The project's development velocity -- a full CLI, watcher, MCP server, tactile pipeline, and screen reader hooks built by a small team -- is partly attributable to AI-assisted development. The "less experienced developers benefit more" finding has equity implications: AI pair programming could enable disabled developers to build their own tools.

---

## Section N: Standards, Legal Frameworks & Regulatory Context

These entries provide the normative and legal grounding the paper needs -- production standards for tactile materials, image description guidelines, and accessibility law.

### N.1 Braille Authority of North America (BANA). (2022). *Guidelines and Standards for Tactile Graphics, 2022.*
- **URL:** https://www.brailleauthority.org/guidelines-and-standards-tactile-graphics
- **Summary:** The definitive North American standard for tactile graphic production. Covers line weights, textures, labeling, Braille placement, spacing, and page layout. 2022 revision updates the 2010 edition for Unified English Braille (UEB) and Nemeth Code in UEB Contexts. Includes best practices developed since 2010.
- **Relevance:** The authoritative standard against which the project's PIAF output must be evaluated. The TACT pipeline's line weights, label sizes, density thresholds, and Braille Grade 2 output via liblouis all reference BANA guidelines. Cite to ground tactile output claims in established standards rather than ad hoc design decisions.

### N.2 DIAGRAM Center. (2015). *Image Description Guidelines.*
- **Publisher:** Benetech / NCAM (Carl and Ruth Shapiro Family National Center for Accessible Media at WGBH)
- **URL:** http://diagramcenter.org/table-of-contents-2.html
- **Summary:** Guidelines for describing images in accessible digital content. Covers style, language, formatting, and layout applicable to all image types, with specific guidance for maps, graphs, diagrams, and other categories. Developed from partnership between DIAGRAM Center and NCAM.
- **Relevance:** The project's Macro/Meso/Micro description framework extends these guidelines into architectural domain specificity. DIAGRAM provides the general-purpose image description foundation; the project's custom GPT prompt adds architectural literacy (spatial relationships, material systems, structural logic, scale references) that DIAGRAM's generic guidelines cannot provide.

### N.3 European Union. (2019/2025). European Accessibility Act (Directive 2019/882).
...
- **Summary:** EU-wide accessibility requirements for digital products and services including computers, software, e-commerce, and electronic communications. Applies to any business with 10+ staff and turnover above 2M EUR that trades in the EU. Penalties up to 3M EUR. Affects 101 million EU citizens with disabilities.
- **Relevance:** The EAA creates a regulatory environment where accessible design tools are not optional. CAD vendors selling in the EU must now meet accessibility requirements. The project anticipates this regulatory trajectory: tools designed for accessibility from the start will comply by default; tools retrofitted for accessibility will struggle. Strengthens Outline E's argument that ACADIA should engage with disability proactively.

### N.4 W3C. (2023). Web Content Accessibility Guidelines (WCAG) 2.2.
- **URL:** https://www.w3.org/TR/WCAG22/
- **Summary:** The international standard for digital accessibility. WCAG 2.2 adds criteria for focus appearance, dragging movements, target size, and consistent help. Level AA is the baseline for most legal compliance frameworks.
- **Relevance:** The CLI's design decisions -- sequential text output, keyboard-only operation, screen-reader-native formatting -- satisfy WCAG principles by architecture rather than by retrofit. The OK:/ERROR: output protocol, the absence of visual-only feedback, and the deterministic command-response pattern are inherently WCAG-compliant. Contrast with Rhino/Grasshopper, which fail multiple WCAG 2.2 success criteria.

### N.5 U.S. Access Board. (2017/2023). Section 508 ICT Standards (Revised).
- **URL:** https://www.access-board.gov/ict/
- **Summary:** Federal accessibility standards for information and communications technology. Apply to all federally funded institutions, including universities receiving federal grants. Incorporate WCAG 2.0 Level AA by reference; 2023 updates align with WCAG 2.1.
- **Relevance:** As a federally funded institution, UIUC is subject to Section 508. The project's tools are used in a public university context; their accessibility is not merely aspirational but legally required. The fact that commercial CAD tools (Rhino, Revit, Grasshopper) do not meet Section 508 standards is a systemic failure the paper can document.

---

## Section O: Multimodal AI for Visual Description & Accessible Interaction

These entries cover multimodal LLM capabilities for image understanding and the emerging ecosystem of AI-powered visual assistance for blind users.

### O.1 Be My Eyes. (2023/2024). "Be My AI: Virtual Volunteer powered by GPT-4."
- **URL:** https://www.bemyeyes.com/news/introducing-be-my-ai-formerly-virtual-volunteer-for-people-who-are-blind-or-have-low-vision-powered-by-openais-gpt-4/
- **Summary:** Integration of GPT-4V into the Be My Eyes app, providing on-demand visual description to blind and low-vision users. Used one million times within weeks of launch. Named among Time's Best Inventions 2023. Users send images via the app; AI provides conversational, contextual descriptions.
- **Relevance:** Be My AI is the closest deployed analog to the project's architectural image description pipeline. The project extends this general-purpose tool with architectural domain specificity (the custom GPT prompt with Macro/Meso/Micro levels). The project's contribution is showing that general-purpose AI vision requires domain scaffolding for architectural description -- Be My AI can describe a building photo, but it cannot analyze a floor plan drawing or describe spatial relationships with architectural precision.

### O.2 OpenAI. (2023/2024). "GPT-4V(ision) System Card."
- **URL:** https://cdn.openai.com/papers/GPTV_System_Card.pdf
- **Summary:** Documents GPT-4V's vision capabilities and limitations, including discussion of accessibility use cases and risks for blind users relying on AI descriptions. Acknowledges that incorrect visual descriptions could mislead blind users.
- **Relevance:** The system card's warning about misleading descriptions for blind users is directly relevant to the project's image description pipeline. The project's Macro/Meso/Micro structure mitigates this risk by providing multiple description levels that cross-validate each other. The project also maintains the CLI as the authoritative design interface -- AI descriptions supplement but do not replace the semantic model.

### O.3 Gurari, D., et al. (2018/2024). "VizWiz Grand Challenge: Answering Visual Questions from Blind People."
- **Venue:** CVPR 2018 (foundational); VizWiz Grand Challenge ongoing through 2024
- **URL:** https://vizwiz.org/tasks-and-datasets/vqa/
- **Summary:** The largest visual question answering dataset sourced from blind users (31,000+ photos with spoken questions). Images are characteristically noisy -- blurry, off-center, poorly lit -- reflecting real blind photography conditions. 28% of questions are unanswerable due to image quality. Ongoing benchmark series through 2024 evaluating multimodal LLMs.
- **Relevance:** VizWiz's "real blind user" data reveals the gap between laboratory image understanding and deployed accessibility. The project's Ray-Ban Meta glasses pipeline encounters similar image quality challenges -- architectural images captured by a blind user may be poorly framed. The project must handle degraded input gracefully, a requirement VizWiz has documented empirically.

### O.4 Inclusion Through Sound (Systematic Review). (2025). "A Systematic Review of Spatial Audio, Sonification, and Interaction Design in Immersive Technologies for Blind and Visually Impaired Users."
- **Venue:** AHFE 2025 Hawaii Edition
- **URL:** https://scholars.hkbu.edu.hk/en/publications/inclusion-through-sound-a-systematic-review-of-spatial-audio-soni/
- **Summary:** Synthesized nearly 1,900 works across six domains: spatial audio and HRTFs, assistive technologies for navigation, sonification and auditory displays, auditory cognition, immersive system design, and inclusive design frameworks. Key finding: for blind users, audio-first design is "not an enhancement but a requirement" enabling orientation, navigation, and equitable participation.
- **Relevance:** The most comprehensive recent review of spatial audio for blind users. Confirms the project's planned sonification pipeline sits in productive territory. The review's six-domain taxonomy provides a framework for positioning the project's sonification ambitions within the broader field. The finding that spatialized audio consistently enhances presence and reduces workload supports integrating spatial audio into the CLI feedback loop.

### O.5 Microsoft. (2020/2023). *Soundscape: 3D Spatial Audio Navigation.*
- **URL:** https://github.com/microsoft/soundscape
- **URL (research):** https://www.microsoft.com/en-us/research/product/soundscape/
- **Summary:** iOS app using 3D spatial audio to help blind users navigate urban environments. Beacons placed on points of interest emit spatialized sound, creating an "audio augmented reality" layer. Open-sourced in January 2023 after six years of development. Community continuation by Scottish Tech Army from August 2023.
- **Relevance:** Soundscape's spatial audio architecture -- placing virtual audio beacons on spatial features -- is directly transferable to the project's sonification ambitions. Architectural elements (columns, walls, openings) could emit spatialized sounds that Daniel hears as he "navigates" a floor plan through headphones. Soundscape's open-source release enables direct code reuse. The app's discontinuation and community continuation also illustrates the sustainability challenges of accessibility technology.

---

## Summary Table

(Updated April 2026 with 27 new entries: E.8 renumbered to E.9, new E.8 added; J.8 added; new sections L, M, N, O added.)

| # | Citation | Year | Venue | S |
|---|---------|------|-------|---|
| ... | *(original 136 entries unchanged -- see above)* | | | |
| 137 | Poirier-Quinot, "Cue-preserving auralisations" | 2025 | Building Acoustics | E |
| 138 | ACADIA 2026 theme: "Humanism Recoded" | 2026 | ACADIA | J |
| 139 | Dorst, "Core of Design Thinking" | 2011 | Design Studies | L |
| 140 | Cross, *Designerly Ways of Knowing* | 2006 | Springer | L |
| 141 | Sanders & Stappers, "Co-creation" | 2008 | CoDesign | L |
| 142 | Ishii & Ullmer, "Tangible Bits" | 1997 | CHI (most-cited) | L |
| 143 | Hurst & Tobias, "DIY Assistive Technology" | 2011 | ASSETS (Impact Award) | L |
| 144 | Anthropic, MCP Specification | 2024 | modelcontextprotocol.io | M |
| 145 | Anthropic, "Introducing MCP" | 2024 | Blog | M |
| 146 | Anthropic, Claude Code | 2025 | Product / GitHub | M |
| 147 | Peng et al., "AI + Developer Productivity" | 2023 | arXiv | M |
| 148 | BANA, *Tactile Graphics Guidelines 2022* | 2022 | Standard | N |
| 149 | DIAGRAM Center, *Image Description Guidelines* | 2015 | Benetech / NCAM | N |
| 150 | EU, European Accessibility Act | 2019/2025 | EU Directive | N |
| 151 | W3C, WCAG 2.2 | 2023 | W3C Standard | N |
| 152 | U.S. Access Board, Section 508 Revised | 2017/2023 | Federal Standard | N |
| 153 | Be My Eyes + GPT-4 ("Be My AI") | 2023/2024 | Product | O |
| 154 | OpenAI, GPT-4V System Card | 2023/2024 | Technical report | O |
...
Even with 157 sources, several areas lack published work -- and the absence is itself a finding:

- **File-watching as accessibility architecture.** No paper examines JSON file-watching as a strategy for decoupling accessible controllers from inaccessible viewers. The MCP specification (M.1, M.2) validates the transport-layer concept; the project's approach is simpler, more robust, and crash-safe. This is a genuine contribution with no direct precedent.
- **Accessibility in ACADIA/CumInCAD remains thin.** Despite 2,500+ CumInCAD papers from 2021–2025, accessibility/disability content barely registers. The project's paper would be among the first to directly address how a blind student uses computational design tools in a graduate architecture studio. The 2026 theme "Humanism Recoded" (J.8) creates the strongest possible framing for this submission.
...
- **BIM accessibility is undocumented.** No academic paper addresses screen reader accessibility in Revit, ArchiCAD, or other BIM platforms. Autodesk publishes Section 508 VPATs but these are compliance documents, not research. The absence of literature IS the finding -- the industry's dominant design tools have never been evaluated for non-visual use.
- **AI pair programming as accessibility methodology.** Claude Code (M.3) and similar agentic tools are documented as developer productivity tools (M.4), but no paper examines AI pair programming as a methodology for building accessible tools -- or as an equalizer enabling small teams to build sophisticated software that would otherwise require large development organizations. The project's development story is itself a contribution.

### Gaps closed in April 2026 update

The following gaps identified during analysis have been addressed with new entries:

| Gap | Status | New entries |
|-----|--------|-------------|
| Design cognition canon (Schon alone was insufficient) | Closed | Dorst (L.1), Cross (L.2) |
| Co-design methodology (Schuler & Namioka referenced but not cited) | Closed | Sanders & Stappers (L.3) |
| Tangible interface precedents for The Desk | Closed | Ishii & Ullmer (L.4) |
| DIY assistive technology / maker movement | Closed | Hurst & Tobias (L.5) |
| MCP as infrastructure | Closed | Anthropic MCP spec (M.1, M.2) |
| AI-assisted development methodology | Closed | Claude Code (M.3), Peng et al. (M.4) |
| Braille / tactile production standards | Closed | BANA 2022 (N.1), DIAGRAM (N.2) |
| Legal / regulatory framework | Closed | EAA (N.3), WCAG 2.2 (N.4), Section 508 (N.5) |
| Multimodal LLM for visual description | Closed | Be My AI (O.1), GPT-4V card (O.2), VizWiz (O.3) |
| Sonification post-2020 | Partially closed | Systematic review (O.4), Soundscape (O.5), Poirier-Quinot (E.8) |
| BIM accessibility | Documented as absence | No sources exist; this is cited as a finding |
| Intersectional / multi-disability | Still open | Sparse literature; not critical for ACADIA submission |

---

## Recommended Reading Order for ACADIA 2026 Framing

**Note on the 2026 theme:** "Humanism Recoded: Reframing Computation and Making through Embodiment and Culture" (J.8) aligns with the project on every axis. "Embodiment" = Merleau-Ponty, haptic cognition, tangible interfaces. "Culture" = visual culture critique, disciplinary politics. "Reframing Computation" = the CLI as alternative computational design paradigm. "Making" = PIAF, 3D prints, pegboard. Frame the paper as a direct response to this theme.
...
**Layer 3 -- Embodied Cognition, Design Thinking, and Representation Theory (the theoretical foundation):**
Merleau-Ponty (A.1), Varela et al. (A.10), Clark & Chalmers (A.11), Schön (A.9), Dorst (L.1), Cross (L.2), Carpo (K.6, K.7), Burry (K.8), Allen (K.4), Deamer (K.10)
...
shapeCAD (I.2), A11yShape (I.14), Rietschel/Raven (G.7, H.6), Text2CAD (H.5), AIDL (H.13), LLMto3D (H.12), Crawford (I.10), Billah (I.9), Clepper et al. (I.16), Flores-Saviaga (I.17), Be My AI (O.1), Soundscape (O.5)

**Layer 6 -- Ethics, Method, and Standards (how we work):**
Charlton (C.2), Costanza-Chock (C.15), Sanders & Stappers (L.3), Seo (I.18), Nicholson/ACSA (C.20), NAAB (J.7), BANA (N.1), WCAG 2.2 (N.4), EAA (N.3)

**Layer 7 -- Infrastructure and Development (how we built it):**
MCP Spec (M.1), Claude Code (M.3), Peng et al. (M.4), Ishii & Ullmer (L.4), Hurst & Tobias (L.5), Section 508 (N.5)

**Layer 8 -- The Project's Contribution (what this makes possible):**
Blesser & Salter (E.7), Lundgard & Satyanarayan (I.5), Wobbrock/Ability-Based Design (C.6), Ladner (C.11), Sennett (A.12), Ingold (A.13), Poirier-Quinot (E.8), Inclusion Through Sound review (O.4)
